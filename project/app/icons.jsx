...
(function () {
  const P = {
    ...
    // 成长：上升趋势线 + 箭头
    trend: 'M4 16l5-5 3 3 7-8m0 0h-4.5m4.5 0v4.5',
    // 象限：横纵坐标轴（带箭头，指向"重要↑×紧急→"），区别于"全览=方块"
    matrix: 'M5 19V5m0 0-2.2 2.2M5 5l2.2 2.2M5 19h14m0 0-2.2-2.2M19 19l-2.2 2.2M9 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm5-4a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z',
  };
  // 填充图标
  const FILL = {
