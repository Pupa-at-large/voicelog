...
- M10 「时间重叠」提示精简：内联横幅只留短句 + 可点 ⓘ（复用「关于一心多用」弹层），新增共享 info 图标
- M11 奥卡姆剃刀文案精简：四象限/多任务/隐私长解释、容量/顺延/成长区横幅说教尾巴、批量·进度·回收站·空状态的重复安慰句、`late better than never` 中英混搭统一清理（移动+Web 一致）
